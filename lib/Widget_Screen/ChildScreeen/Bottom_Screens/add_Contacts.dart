...
class _AddContactsPageState extends State<AddContactsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor:THelperFunction.isDarkMode(context)?Colors.black:Colors.white, // Set the background color here
      body: SafeArea(
        child: Container(
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Text("Note: When you add trusted contacts then restart your app...",
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return Card(
                      color: THelperFunction.isDarkMode(context)
                          ...
                          : TColors.light,
                      elevation: 2,
                      shadowColor: THelperFunction.isDarkMode(context)
                          ? TColors.light
                          : TColors.dark,
                      child: Padding(
